var site_settings = '<div class="ts-button">'
    ...
    +'<div class="ts-body">'
        ...
        +'<div class="ts-themes">'
            +'<a href="#" class="active" data-theme="' + document.getElementById('contextPath').value + 'css/theme-default.css"><img src="' + document.getElementById('contextPath').value + 'img/themes/default.jpg"/></a>'            
            +'<a href="#" data-theme="' + document.getElementById('contextPath').value + 'css/theme-brown.css"><img src="' + document.getElementById('contextPath').value + 'img/themes/brown.jpg"/></a>'
            +'<a href="#" data-theme="' + document.getElementById('contextPath').value + 'css/theme-blue.css"><img src="' + document.getElementById('contextPath').value + 'img/themes/blue.jpg"/></a>'                        
            +'<a href="#" data-theme="' + document.getElementById('contextPath').value + 'css/theme-white.css"><img src="' + document.getElementById('contextPath').value + 'img/themes/light.jpg"/></a>'            
            +'<a href="#" data-theme="' + document.getElementById('contextPath').value + 'css/theme-black.css"><img src="' + document.getElementById('contextPath').value + 'img/themes/black.jpg"/></a>'
        +'</div>'
