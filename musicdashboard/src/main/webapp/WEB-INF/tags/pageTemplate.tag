...
<title>${titulo} - MusicDashboard</title>
...
<body>
	...
	<div class="page-container">
		...
		<div class="page-sidebar">
			...
			<ul class="x-navigation">
				<li class="xn-logo">
					<a href="${s:mvcUrl('HC#home').build()}">Music Dashboard</a> <a href="#" class="x-navigation-control"></a>
				</li>
				<li class="xn-profile">
					<div class="profile">
						<div class="profile-image">
							<img
								src="${pageContext.request.contextPath}/resources/img/spotify_logo.png"
								alt="Spotify" />
						</div>
						<div class="profile-data">
							<div class="profile-data-name">Powered By</div>
						</div>
					</div></li>
			...
			<ul class="x-navigation x-navigation-horizontal x-navigation-panel">
				...
				<li class="xn-search">
					<form:form action="${s:mvcUrl('HC#findArtist').arg(0, artistName).build()}" method="GET">
						<input type="text" name="artistName" placeholder="Artist Search..." />
					</form:form>
				</li>
				<!-- END SEARCH -->
				<!-- SIGN OUT -->
					...
					<div
						...
						<div class="panel-body list-group list-group-contacts scroll"
							...
							<a href="#" class="list-group-item">
								...
								src="${pageContext.request.contextPath}/resources/assets/images/users/user2.jpg" class="pull-left"
								alt="John Doe" /> <span class="contacts-title">John Doe</span>
								<p>Praesent placerat tellus id augue condimentum</p>
							</a> <a href="#" class="list-group-item">
								<div class="list-group-status status-away"></div> <img
								src="${pageContext.request.contextPath}/resources/assets/images/users/user.jpg" class="pull-left"
								alt="Dmitry Ivaniuk" /> <span class="contacts-title">Dmitry
									Ivaniuk</span>
								<p>Donec risus sapien, sagittis et magna quis</p>
							</a> <a href="#" class="list-group-item">
								<div class="list-group-status status-away"></div> <img
								src="${pageContext.request.contextPath}/resources/assets/images/users/user3.jpg" class="pull-left"
								alt="Nadia Ali" /> <span class="contacts-title">Nadia Ali</span>
								<p>Mauris vel eros ut nunc rhoncus cursus sed</p>
							</a> <a href="#" class="list-group-item">
								<div class="list-group-status status-offline"></div> <img
								src="${pageContext.request.contextPath}/resources/assets/images/users/user6.jpg" class="pull-left"
	...
	<!-- START SCRIPTS -->
        ...
        <script type="text/javascript" src="${pageContext.request.contextPath}/resources/js/plugins/blueimp/jquery.blueimp-gallery.js"></script>
        <script type="text/javascript" src="${pageContext.request.contextPath}/resources/js/plugins/blueimp/blueimp-gallery.js"></script>
        <script type="text/javascript" src="${pageContext.request.contextPath}/resources/js/plugins/dropzone/dropzone.min.js"></script>
        <script type="text/javascript" src="${pageContext.request.contextPath}/resources/js/plugins/icheck/icheck.min.js"></script>
        <!-- END THIS PAGE PLUGINS-->        

        <!-- START TEMPLATE -->
        <script type="text/javascript" src="${pageContext.request.contextPath}/resources/js/settings.js"></script>
